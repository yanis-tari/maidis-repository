...
public class MedicalItemImpl  extends RdfBean<Subjective> implements MedicalItem,Serializable {
	
	@Transient
	private static final long serialVersionUID = -5818287659661656749L;
	@Generated
	@Id
	private String id;
	...
	public MedicalItemImpl() {
		super();
		this.id = new UID().toString();
	}

	public MedicalItemImpl(String label,String commentOfMedicalItem, Date endDateOfMedicalItem,
