...
public class Pulse extends RdfBean<Pulse> implements Serializable, VitalSigns {
	 ...
	 */
	@Transient
	private static final long serialVersionUID = -7746237245188632155L;
	@Transient
	public static String BPM = "bpm";
	@Transient
	public static String SNOMED_ID="http://snomed.info/id/78564009";
	...
	@RdfProperty(MdsVocabulary.pulseValue)
	...
	public Pulse(){
		...
		this.hasLabel = "Pulse rate";	
		this.hasNomenclatureCode = Pulse.SNOMED_ID;
	...
	public Pulse(Double value, String unit) {
		super();
		this.hasType = MiType.XS;
		this.hasLabel = "Pulse rate";	
		this.hasNomenclatureCode = Pulse.SNOMED_ID;
	...
	public Pulse(Double value, String unit, Date endDateOfMedicalItem,
