...
public class Subjective extends RdfBean<Subjective> implements MedicalItem,Serializable {
	...
	public Subjective(String label,String commentOfMedicalItem, Date endDateOfMedicalItem,
