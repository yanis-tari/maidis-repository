...
public class Height extends RdfBean<Height> implements Serializable, Measurement {	
	/**
	 * 
	 */
	@Transient
	...
	@RdfProperty(MdsVocabulary.heightValue)
	...
	public Height(Double value, String unit, Date endDateOfMedicalItem,
