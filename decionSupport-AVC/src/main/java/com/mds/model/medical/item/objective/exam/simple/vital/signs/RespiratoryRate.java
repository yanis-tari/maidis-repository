...
import com.mds.model.medical.item.objective.exam.VitalSigns;
	...
	public class RespiratoryRate extends RdfBean<RespiratoryRate> implements Serializable, VitalSigns {
		...
		@Transient
		public static final String SNOMED_ID="http://snomed.info/id/86290005";
		
		@Transient
		public static final String perMinute = "/min";
		...
		@RdfProperty(MdsVocabulary.RRvalue)
		...
		public RespiratoryRate(){			
			...
			this.hasLabel = "Respiratory Rate";	
		...
		public RespiratoryRate(Double value, String unit) {
			super();
			this.hasType = MiType.XS;
			this.hasLabel = "Respiratory Rate";	
			this.hasNomenclatureCode = SNOMED_ID;
		...
		public RespiratoryRate(Double value, String unit, Date endDateOfMedicalItem,
