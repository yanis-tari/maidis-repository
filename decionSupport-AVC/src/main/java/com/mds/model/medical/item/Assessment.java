...
public class Assessment extends RdfBean<Assessment> implements MedicalItem,Serializable {
	
	/**
	 * 
	 */
	@Transient
	private static final long serialVersionUID = 3627136616995914262L;
	@Generated
	@Id
	private String id;
	...
	public Assessment(String commentOfMedicalItem, Date endDateOfMedicalItem,
			...
			URI hasContext, URI hasGeographicalLocation, String hasNomenclatureCode) {
		super();
		this.id = new UID().toString();
	...
	public String toString() {
		return "Assessment [id=" + id + ", hasType=" + hasType + ", hasLabel="
				+ hasLabel + ", commentOfMedicalItem=" + commentOfMedicalItem
				+ ", endDateOfMedicalItem=" + endDateOfMedicalItem
				+ ", startDateOfMedicalItem=" + startDateOfMedicalItem
				+ ", hasEffectTime=" + hasEffectTime + ", hasTimeStamp="
				+ hasTimeStamp + ", hasAmount=" + hasAmount
				+ ", hasMedicalObject=" + hasMedicalObject + ", hasSource="
				+ hasSource + ", isPartOf=" + isPartOf + ", hasContext="
				+ hasContext + ", hasGeographicalLocation="
				+ hasGeographicalLocation + ", hasNomenclatureCode="
				+ hasNomenclatureCode + ", hasNomenclatueClass="
				+ hasNomenclatueClass + "]";
	}
}
