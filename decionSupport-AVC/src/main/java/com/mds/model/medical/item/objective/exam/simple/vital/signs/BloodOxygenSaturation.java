...
public class BloodOxygenSaturation  extends RdfBean<BloodOxygenSaturation> implements Serializable, VitalSigns {
	/**
	 * 
	 */
	@Transient
	private static final long serialVersionUID = 8291791282136524570L;
	@Transient
	public static String SNOMED_ID=	"http://snomed.info/id/103228002";
	@Transient
	...
	@RdfProperty(MdsVocabulary.bloodOxygenSaturationValue)
	...
	public BloodOxygenSaturation() {
		...
		this.hasLabel = "Blood Oxygen Saturation";
		this.hasNomenclatureCode = BloodOxygenSaturation.SNOMED_ID;
	...
	public BloodOxygenSaturation(Double value, String unit) {
		super();
		this.hasType = MiType.XS;
		this.hasLabel = "Blood Oxygen Saturation";
		this.hasNomenclatureCode = BloodOxygenSaturation.SNOMED_ID;
	...
	public BloodOxygenSaturation(String id, String hasLabel, Double value,
	...
	public BloodOxygenSaturation(String hasLabel, Double value, String unit,
			String stringValue, String commentOfMedicalItem,
			Date endDateOfMedicalItem, Date startDateOfMedicalItem,
			Date hasEffectTime, Date hasTimeStamp,
	...
	public void setStringValue(String value) {
		  try { 
		       ...
		       this.stringValue = value;
		    	...
		    	System.out.println("error when initialise pulse value, the value is not a number !!");
		    	this.stringValue = value;
		        this.value = 0.0;
		    }
