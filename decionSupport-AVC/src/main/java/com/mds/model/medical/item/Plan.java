...
public class Plan extends RdfBean<Plan> implements MedicalItem,Serializable {
	...
	public Plan(String label,String commentOfMedicalItem, Date endDateOfMedicalItem,
