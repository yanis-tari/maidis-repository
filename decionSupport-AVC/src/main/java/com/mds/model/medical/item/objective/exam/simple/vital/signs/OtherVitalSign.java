...
public class OtherVitalSign extends RdfBean<OtherVitalSign> implements Serializable, VitalSigns {

	/**
	 * 
	 */
	@Transient
	private static final long serialVersionUID = 5012835568586232698L;
	...
	public OtherVitalSign(String label ,Double value, String unit) {
		super();
		this.hasType = MiType.XS;
		this.hasLabel = label;			
		this.id = new UID().toString();
	...
	public OtherVitalSign(Double value, String unit, Date endDateOfMedicalItem,
	...
	public OtherVitalSign(Double value, String unit, 
